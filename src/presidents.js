...
function getNames(presidentsArr) {
	let presNames = presidentsArr.map((president) => {
...
function getDemocraticPresidents(presidentsArr) {
	let presidentParty = presidentsArr.filter((president) => {
...
function countYearsInOffice(presidentsArr) {
	let yearsInOffice = presidentsArr.reduce((acc, el) => {
		if (el.leftOffice !== null) {
			let years = el.leftOffice - el.tookOffice
			return acc + years
		} else {
			return acc
		}
...
function sortPresidentsByBirthYear(presidentsArr) {
	let sorted = presidentsArr.sort((a, b) => {
...
function getAgeAtInauguration(presidentsArr) {
	let ageAtIn = presidentsArr.map((president) => {
...
function getPresidentsBornAfter(presidentsArr, year) {
	let bornAfter = presidentsArr.filter((president) => {
...
function countRepublicanPresidents(presidentsArr) {
	let repubCount = presidentsArr.reduce((acc, el) => {
		if (el.party === 'Republican') {
			return (acc += 1)
		} else {
			return acc
		}
...
function sortPresidentsByName(presidentsArr) {
	let sortedPresidents = presidentsArr.sort((a, b) => {
